...
```mermaid
graph LR;
    classDef currentCategoryGemStyle fill:#E0EFFF,stroke:#70A1D7,color:#000,stroke-width:1.5px;
    classDef otherEgGemStyle fill:#D4EFDF,stroke:#58D68D,color:#000;
    classDef externalGemCatStyle fill:#FADBD8,stroke:#EC7063,color:#000;
