  ...
  class GraphQL
    ...
    class DatastoreQuery < Support::MemoizableData.define(
      ...
      def all_docvalue_fields
        @all_docvalue_fields ||= initial_search_index_definitions.flat_map do |index_def|
      ...
      # Returns true only when every initially targeted index definition agrees the field should be
      ...
      def requested_via_doc_values?(field_path)
        ...
        field_definitions = initial_search_index_definitions.filter_map do |index_def|
