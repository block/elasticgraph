...
module ElasticGraph
  class GraphQL
    ...
    # @dynamic datastore_query_builder, field_retrieval_planner, graphql_gem_plugins, graphql_adapter, resolver_query_adapter, named_graphql_resolvers, datastore_query_adapters, monotonic_clock
