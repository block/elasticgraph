...
module ElasticGraph
  ...
  RSpec.shared_context "ElasticGraph GraphQL acceptance support", :factories, :json_ingestion_support, :uses_datastore, :builds_indexer, :capture_logs, :builds_admin do
