...
Gem::Specification.new do |spec|
  spec.name = "elasticgraph-indexer"
  ...
  spec.license = "MIT"
  spec.summary = "Indexes ElasticGraph data into a datastore."
  ...
  spec.add_development_dependency "elasticgraph-proto_ingestion", ElasticGraph::VERSION
