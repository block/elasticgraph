...
module ElasticGraph
  RSpec.describe Indexer do
    ...
    it "preserves injected ingestion adapters by format" do
      adapters = {"test" => Object.new}

      expect(build_indexer(ingestion_adapters_by_format: adapters).ingestion_adapters_by_format).to include(adapters)
    end
