...
module ElasticGraph
  module IndexerLambda
    ...
    class SqsProcessor
      ...
      def initialize(indexer, ignore_sqs_latency_timestamps_from_arns:, s3_client: nil)
        @indexer = indexer
      ...
      def process(lambda_event, refresh_indices: false)
        ...
        failures = @indexer.process_returning_failures(decoded_events, refresh_indices: refresh_indices)
      ...
      # {
      #   "Records" => [
      #     {"body" => <payload understood by the format-specific indexer>},
      #     {"body" => <payload understood by the format-specific indexer>},
      #     ...
      #   ]
      # }
