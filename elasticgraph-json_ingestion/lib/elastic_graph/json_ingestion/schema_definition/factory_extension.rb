...
require "elastic_graph/json_ingestion/schema_definition/index_extension"
      ...
      module FactoryExtension
        ...
        def new_scalar_type(name)
          super(name) do |type|
            ...
            if (built_in_json_schema_options = BuiltInTypesExtension::BUILT_IN_SCALAR_JSON_SCHEMA_OPTIONS_BY_NAME[name])
