...
require "elastic_graph/json_ingestion/schema_definition/field_type/object_extension"
      ...
      module ObjectInterfaceExtension
        ...
        def to_indexing_field_type
          ...
          if field_type.is_a?(ElasticGraph::SchemaDefinition::Indexing::FieldType::Union)
            FieldType::Union.new(field_type)
          else
            FieldType::Object.new(field_type, json_schema_options: json_schema_options)
          end
        end
      end
    end
