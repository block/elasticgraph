      ...
      module SchemaElements
        ...
        module ObjectInterfaceExtension
          ...
          def to_indexing_field_type
            # @type var field_type: ElasticGraph::SchemaDefinition::Indexing::FieldType::Object | ElasticGraph::SchemaDefinition::Indexing::FieldType::Union
            field_type = _ = super

            if field_type.is_a?(ElasticGraph::SchemaDefinition::Indexing::FieldType::Union)
              return Indexing::FieldType::Union.wrap(field_type)
            end

            Indexing::FieldType::Object.wrap(field_type, json_schema_options: json_schema_options)
          end
        end
      end
    end
