  ...
  module JSONIngestion
    RSpec.describe Indexer, :ingests_json_data, :factories do
      ...
      it "tolerates integer-valued-but-float-typed version values, since JSON has no integer type" do
        ...
        event = build_upsert_event(:component, id: "json-indexer-float-version", name: "version_as_float")
      ...
      it "reports a malformed envelope alongside a record failure, while still indexing the valid events" do
        malformed_event = build_upsert_event(:component, id: "json-indexer-malformed", name: "malformed").except("version")
        invalid_event = build_upsert_event(:component, id: "json-indexer-invalid", name: 17)
        valid_event = build_upsert_event(:component, id: "json-indexer-valid", name: "valid")
