...
module ElasticGraph
  module JSONIngestion
    RSpec.describe RecordPreparerFactory, :json_ingestion_support do
    ...
    RSpec.describe RecordPreparerFactory, "record preparation for old JSON schema versions", :json_ingestion_support do
