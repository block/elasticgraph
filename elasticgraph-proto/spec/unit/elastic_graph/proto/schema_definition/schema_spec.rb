      ...
      RSpec.describe Schema, :proto_schema do
        ...
        it "raises an error when a custom scalar does not configure proto_field" do
          ...
          expect {
            ...
            "Proto field type not configured for scalar type `UnconfiguredScalar`.",
        ...
        it "escapes proto keywords in generated identifiers" do
          ...
          expect(proto_schema_from(results)).to include("option_ = 1; // source name: option")
          expect(proto_schema_from(results)).to include("stream_ = 2; // source name: stream")
        ...
        it "can source enum values from configured proto enum mappings" do
          ...
          generated = proto_schema_from(results)
          expect(generated).to include("ACTIVE = 1;")
          expect(generated).to include("INACTIVE = 2;")
          expect(generated).to include("LEGACY = 3;")
        ...
        it "raises when mapped proto enum sources produce inconsistent values" do
          ...
          expect {
            ...
            "Proto enum mappings for `Status` produce inconsistent value sets"
          ))
        end

        it "can be configured to replace json schema artifacts" do
          results = define_proto_schema do |s|
            s.proto_schema_artifacts replace_json_schemas: true
