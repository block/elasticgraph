...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency "elasticgraph-indexer_lambda", ElasticGraph::VERSION
  ...
  spec.add_development_dependency "elasticgraph-warehouse_lambda", ElasticGraph::VERSION
end
