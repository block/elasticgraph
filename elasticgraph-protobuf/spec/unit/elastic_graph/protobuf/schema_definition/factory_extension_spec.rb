    ...
    module SchemaDefinition
      RSpec.describe FactoryExtension do
        ...
        it "extends enum types with enum conversion behavior" do
          ...
          expect(type).to be_a(SchemaElements::EnumTypeExtension)
        end
        ...
        it "extends interface and union types with object conversion behavior" do
          ...
          expect(factory.new_interface_type("Node")).to be_a(SchemaElements::ObjectInterfaceAndUnionExtension)
          ...
          expect(factory.new_union_type("SearchResult")).to be_a(SchemaElements::ObjectInterfaceAndUnionExtension)
        ...
        it "extends object and scalar types and yields to provided blocks" do
          ...
          expect(object_type).to be_a(SchemaElements::ObjectInterfaceAndUnionExtension)
          expect(scalar_type).to be_a(SchemaElements::ScalarTypeExtension)
          expect(factory.new_object_type("Account")).to be_a(SchemaElements::ObjectInterfaceAndUnionExtension)
          expect(factory.new_scalar_type("Custom")).to be_a(SchemaElements::ScalarTypeExtension)
        end
