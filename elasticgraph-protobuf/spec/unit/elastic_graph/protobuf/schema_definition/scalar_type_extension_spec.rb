    ...
    module SchemaDefinition
      RSpec.describe ScalarTypeExtension do
        ...
        it "raises when json_schema type cannot be inferred" do
          ...
          }.to raise_error(Errors::SchemaError, a_string_including("Protobuf field type not configured for scalar type `Ambiguous`"))
        end
        ...
        it "raises when json_schema type is not a string, symbol, or array" do
          ...
          expect {
            scalar.to_proto_field_type
          }.to raise_error(Errors::SchemaError, a_string_including("Protobuf field type not configured for scalar type `Unknown`"))
        end
        ...
        it "raises when no json_schema_options are exposed" do
          ...
          expect {
            scalar.to_proto_field_type
          }.to raise_error(Errors::SchemaError, a_string_including("Protobuf field type not configured for scalar type `WithoutJsonSchema`"))
        end
      end
    end
  end
