...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "elasticgraph-json_ingestion", ElasticGraph::VERSION # JSON ingestion serializer, auto-applied by default for backward compatibility
  ...
  spec.add_dependency "graphql", "~> 2.5.22"
