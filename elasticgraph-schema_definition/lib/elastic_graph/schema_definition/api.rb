...
require "elastic_graph/schema_definition/json_ingestion_compatibility"
  ...
  module SchemaDefinition
    ...
    class API
      ...
      def initialize(
        ...
        # Apply built-in JSON ingestion support for backward compatibility, then
        # allow any explicitly provided extensions to customize the API as well.
        extend JSONIngestion::SchemaDefinition::APIExtension
