  ...
  module SchemaDefinition
    module Mixins
      ...
      module HasTypeInfo
        ...
        #
        # The default implementation returns an empty hash; ingestion extensions (such as
        ...
        # call `json_schema(...)` without having to detect whether an ingestion extension is loaded.
        #
        # @return [Hash<Symbol, Object>] JSON schema options
        def json_schema_options
          # :nocov: -- only reached when no ingestion extension is loaded; the JSON Ingestion
        ...
        #
        # The default implementation is a no-op; an ingestion extension overrides this on the
        ...
        def json_schema(**options)
          # :nocov: -- only reached when no ingestion extension is loaded.
          # :nocov:
        end
