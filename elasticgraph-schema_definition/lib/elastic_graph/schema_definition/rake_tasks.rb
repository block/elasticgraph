...
module ElasticGraph
  module SchemaDefinition
    ...
    class RakeTasks < ::Rake::TaskLib
      ...
      #   You are responsible for ensuring that it is installed if you enable this feature. If you enable this and the plugin is not
      ...
      #   getting aggregated metric values, pass `{AggregatedValues: "%{base}Metrics"}`. See {SchemaElements::TypeNamer::DEFAULT_FORMATS}
