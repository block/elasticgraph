  ...
  module SchemaDefinition
    module SchemaElements
      ...
      class TypeNamer < ::Struct.new(:formats, :regexes, :name_overrides, :reverse_overrides)
        ...
        # @private
        #
        # @param format_overrides [Hash{Symbol => String}] overrides for the default derived type name formats
        # @param name_overrides [Hash{String => String}] specific type name overrides
        ...
        # @private
        #
        # @param standard_name [String, Symbol] the standard name to look up
        ...
        # @private
        #
        # @param potentially_overriden_name [String] a name that may have been overridden
        ...
        # @private
        #
        # @param name [String] the generated name to extract the base from
        # @param format [Symbol] the format key to match against
        ...
        # @param format_name [Symbol] the format key to match against
        ...
        # @private
        #
        # @param format [String] a format string containing `%{placeholder}` tokens
