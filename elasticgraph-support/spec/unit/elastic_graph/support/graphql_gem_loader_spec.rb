...
module ElasticGraph
  module Support
    RSpec.describe GraphQLGemLoader do
      ...
      describe ".load" do
        it "prints a yellow warning to stderr when graphql-c_parser is unavailable", :except_jruby do
        ...
        it "prints the warning only once across multiple calls", :except_jruby do
          simulate_missing_gems "graphql/c_parser"
