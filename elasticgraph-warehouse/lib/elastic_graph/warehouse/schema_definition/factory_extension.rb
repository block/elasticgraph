      ...
      module FactoryExtension
        ...
        def new_schema_artifact_manager(...)
          super.tap do |manager|
            ...
            # @type var manager_with_ext: ElasticGraph::SchemaDefinition::SchemaArtifactManager & SchemaArtifactManagerExtension
            manager_with_ext = _ = manager
            manager_with_ext.add_warehouse_artifact
          end
        end
      end
    end
