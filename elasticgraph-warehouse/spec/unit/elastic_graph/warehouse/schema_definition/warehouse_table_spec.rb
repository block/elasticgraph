  ...
  module Warehouse
    module SchemaDefinition
      RSpec.describe WarehouseTable, :warehouse_schema do
        ...
        it "allows excluding an index from the warehouse" do
          results = define_warehouse_schema do |s|
          ...
          expect(internal_type.index_def.warehouse_table_def).to be_a(Symbol)
          expect(internal_type.index_def.warehouse_table_def).not_to be_a(WarehouseTable)
        end
